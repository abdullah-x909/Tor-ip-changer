...
echo -e "${RED}"
echo "TOR"
echo " _        _______  _______  ______                    _________ _______ ";
echo "( \      (  ___  )(  ___  )(  __  \     |\     /|     \__   __/(  ____ )";
echo "| (      | (   ) || (   ) || (  \  )    ( \   / )        ) (   | (    )|";
echo "| |      | |   | || (___) || |   ) |     \ (_) /         | |   | (____)|";
echo "| |      | |   | ||  ___  || |   | |      ) _ (          | |   |  _____)";
echo "| |      | |   | || (   ) || |   ) |     / ( ) \         | |   | (      ";
echo "| (____/\| (___) || )   ( || (__/  )    ( /   \ )     ___) (___| )      ";
echo "(_______/(_______)|/     \|(______/_____|/     \|_____\_______/|/       ";
echo "                                  (_____)       (_____)                 ";
echo "                                                               v2         ";
echo -e "${NC}"
echo -e "${RED}           Author:github.com/abdullah-x909 ${NC}"
echo -e "${BLUE}=========================================================${NC}\n"
...
read -p "Enter Tor IP change interval (seconds, default 300): " TIME_INTERVAL
TIME_INTERVAL=${TIME_INTERVAL:-300}
